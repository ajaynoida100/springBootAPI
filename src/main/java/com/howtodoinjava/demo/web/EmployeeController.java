...
public class EmployeeController
{
    ...
    public ResponseEntity<EmployeeEntity> getEmployeeByLastName(@PathVariable("lastname") String lastname)
                                                    throws RecordNotFoundException {
        EmployeeEntity entity = service.getEmployeeByLastName(lastname);
